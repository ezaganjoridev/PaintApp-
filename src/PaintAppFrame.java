...
public class PaintAppFrame extends JFrame implements MouseListener, MouseMotionListener, ActionListener {
	...
	private static double FRAME_SCALE = 0;
	...
	final String[] BUTTON_ICONS = { "icons/bigger.png", "icons/smaller.png", "icons/wider.png", "icons/narrow.png",
			...
			"icons/right.png", "icons/resetimage.png", "icons/leftr.png","icons/rightr.png", "icons/wordart.png" };
	...
	final String[] BUTTON_NAMES = { "Make Image Bigger", "Make Image Smaller", "Make Image Wider",
			...
			"Make Image Go Left", "Make Image Go Right", "Reset Image", "Rotate Left", "Rotate Right",  "Insert Text" };

	final int[] MNEMONICS = { KeyEvent.VK_B, KeyEvent.VK_S, KeyEvent.VK_W, KeyEvent.VK_N, KeyEvent.VK_T, KeyEvent.VK_H,
			KeyEvent.VK_U, KeyEvent.VK_D, KeyEvent.VK_L, KeyEvent.VK_R, KeyEvent.VK_CANCEL, KeyEvent.VK_E, KeyEvent.VK_F, KeyEvent.VK_P };
	// Init buttons
	...
	PaintAppFrame() {
		...
		content.add(paintCanvas, BorderLayout.CENTER);
				scroll = new JScrollPane(getContentPane(),
		...
		toolsMenu = new JMenu("Image Options");
			...
			if (i == 13) {
				...
				tbButtons[i].addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						else if (source.equals(BUTTON_NAMES[11]))
							rotate90();

						else if (source.equals(BUTTON_NAMES[12]))
							rotateN90();
					}
				});
			}
	...
	public static Line2D.Float createLine(int x1, int y1, int x2, int y2) {
		...
		public MySlider() {
			...
			table.put(new Integer(0), new JLabel("Zoom out"));
			...
			table.put(new Integer(60), new JLabel("60"));
			table.put(new Integer(70), new JLabel("70"));
			table.put(new Integer(80), new JLabel("80"));
			table.put(new Integer(90), new JLabel("90"));
			table.put(new Integer(100), new JLabel("Zoom in"));
		...
		public void stateChanged(ChangeEvent arg0) {
			...
			if (value < starterValue) {
				...
				System.out.println("CANVAS => " + paintCanvas.getWidth() + "\t"
						+ paintCanvas.getHeight());
				int w = (int) (paintCanvas.getWidth() - (FRAME_SCALE));
				int h = (int) (paintCanvas.getHeight() - (FRAME_SCALE));
				System.out.println("RESIZE PANEL =>" + w + "-------->" + h);
				oldValue = value;
				value = ((JSlider) arg0.getSource()).getValue();
